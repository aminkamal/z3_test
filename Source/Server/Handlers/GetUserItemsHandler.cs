...
namespace Z3Test
{
    namespace Server
    {
        ...
        {
            public static async void GetUserItemsHandler(ApplicationContext appCtx, HttpListenerContext ctx, List<string> urlParams, AccessToken accessToken)
            {
                ...
                await Response.Write(ctx, 200, user.Items);
            }
        }
    }
}
