    ...
    namespace Inventory
    {
        public class ShopManager
        {
            ...
            public ShopManager(IDataStore<PurchasableItem> purchasableItemsStore)
            {
                ...
                purchasableItemsStore.Add(new PurchasableItem{ID="200", GrantItemID="base_warrior", PriceGems=500, Description="Warrior (Melee)", Quantity=1, Rarity=1,Type=ItemType.UNIT});
